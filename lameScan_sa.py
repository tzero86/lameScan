...
def scan(target):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=lameScan_config['max_thread_workers']) as threaded_scans:
...
def get_range():
    ...
    if '-' in ports_range:
        ...
        scan_config['run_top1k_ports'] = True
        #  pass
